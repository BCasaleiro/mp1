...
fstunion output/1st/x_s.fst output/1st/x_z.fst > output/1st/step_t.fst

fstrmepsilon output/1st/step_t.fst > output/1st/step1.fst

fstdraw    --isymbols=letras.sym --osymbols=letras.sym  output/1st/step1.fst | dot -Tpdf  > output/1st/step2.pdf

#testes:
#exame
fstcompose output/1st/exame.fst output/1st/step1.fst > output/1st/test1.fst
fstdraw --isymbols=letras.sym --osymbols=letras.sym  output/1st/test1.fst | dot -Tpdf > output/1st/test1.pdf

#extra
fstcompose output/1st/extra.fst output/1st/step1.fst > output/1st/test2.fst
