...
fstrmepsilon output/1st/t-1st.fst | fstarcsort > output/final/final.fst
fstdraw    --isymbols=syms.txt --osymbols=syms.txt  output/final/final.fst | dot -Tpdf  > output/1st/1st.pdf
...
fstrmepsilon output/3rd/t-3rd.fst | fstarcsort > output/final/final.fst
fstdraw --isymbols=syms.txt --osymbols=syms.txt  output/final/final.fst | dot -Tpdf  > output/3rd/3rd.pdf
...
# 1st with 2nd -> t-1
#-------------------------------------------------------------------------------
fstcompose output/final/final.fst output/2nd/2nd.fst > output/final/t-1.fst
fstdraw --isymbols=syms.txt --osymbols=syms.txt  output/final/t-1.fst | dot -Tpdf > output/final/t-1.pdf
# t-1 with 3rd -> t-2
#-------------------------------------------------------------------------------
fstcompose output/final/t-1.fst output/final/final.fst > output/final/t-2.fst
