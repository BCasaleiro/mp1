...
fstcompose output/final/bernardo.fst output/final/final.fst > output/4th/r-bernardo.fst
fstdraw --isymbols=syms.txt --osymbols=syms.txt  output/final/r-bernardo.fst | dot -Tpdf > output/4th/r-bernardo.pdf

fstcompile --isymbols=syms.txt --osymbols=syms.txt  input/final/casaleiro.txt | fstarcsort > output/final/casaleiro.fst
fstcompose output/final/casaleiro.fst output/final/final.fst > output/4th/r-casaleiro.fst
fstdraw --isymbols=syms.txt --osymbols=syms.txt  output/final/r-casaleiro.fst | dot -Tpdf > output/4th/r-casaleiro.pdf

fstcompile --isymbols=syms.txt --osymbols=syms.txt  input/final/joao.txt | fstarcsort > output/final/joao.fst
fstcompose output/final/joao.fst output/final/final.fst > output/4th/r-joao.fst
fstdraw --isymbols=syms.txt --osymbols=syms.txt  output/final/r-joao.fst | dot -Tpdf > output/4th/r-joao.pdf

fstcompile --isymbols=syms.txt --osymbols=syms.txt  input/final/godinho.txt | fstarcsort > output/final/godinho.fst
fstcompose output/final/godinho.fst output/final/final.fst > output/4th/r-godinho.fst
fstdraw --isymbols=syms.txt --osymbols=syms.txt  output/final/r-godinho.fst | dot -Tpdf > output/4th/r-godinho.pdf
