...
fstcompose output/2nd/chucha.fst output/1st/1st.fst > output/2nd/r-chucha.fst
...
fstcompose output/2nd/acachar.fst output/1st/1st.fst > output/2nd/r-acachar.fst
...
fstcompose output/2nd/achacar.fst output/1st/1st.fst > output/2nd/r-achacar.fst
...
fstcompose output/2nd/acho.fst output/1st/1st.fst > output/2nd/r-acho.fst
...
fstcompose output/2nd/chines.fst output/1st/1st.fst > output/2nd/r-chines.fst
...
fstcompose output/2nd/pichar.fst output/1st/1st.fst > output/2nd/r-pichar.fst
...
fstcompose output/2nd/acolhimento.fst output/1st/1st.fst > output/2nd/r-acolhimento.fst
...
fstcompose output/2nd/alho.fst output/1st/1st.fst > output/2nd/r-alho.fst
...
fstcompose output/2nd/alilha.fst output/1st/1st.fst > output/2nd/r-alilha.fst
...
fstcompose output/2nd/bisbilhotar.fst output/1st/1st.fst > output/2nd/r-bisbilhotar.fst
...
fstcompose output/2nd/lhama.fst output/1st/1st.fst > output/2nd/r-lhama.fst
...
fstcompose output/2nd/lhe.fst output/1st/1st.fst > output/2nd/r-lhe.fst
...
fstcompose output/2nd/banhista.fst output/1st/1st.fst > output/2nd/r-banhista.fst
...
fstcompose output/2nd/castanha.fst output/1st/1st.fst > output/2nd/r-castanha.fst
...
fstcompose output/2nd/menininho.fst output/1st/1st.fst > output/2nd/r-menininho.fst
...
fstcompose output/2nd/nenhum.fst output/1st/1st.fst > output/2nd/r-nenhum.fst
...
fstcompose output/2nd/nhazinha.fst output/1st/1st.fst > output/2nd/r-nhazinha.fst
...
fstcompose output/2nd/arrasar.fst output/1st/1st.fst > output/2nd/r-arrasar.fst
...
fstcompose output/2nd/carro.fst output/1st/1st.fst > output/2nd/r-carro.fst
...
fstcompose output/2nd/corrupto.fst output/1st/1st.fst > output/2nd/r-corrupto.fst
...
fstcompose output/2nd/errar.fst output/1st/1st.fst > output/2nd/r-errar.fst
...
fstcompose output/2nd/raro.fst output/1st/1st.fst > output/2nd/r-raro.fst
...
fstcompose output/2nd/espesso.fst output/1st/1st.fst > output/2nd/r-espesso.fst
...
fstcompose output/2nd/massa.fst output/1st/1st.fst > output/2nd/r-massa.fst
...
fstcompose output/2nd/microssegundo.fst output/1st/1st.fst > output/2nd/r-microssegundo.fst
...
fstcompose output/2nd/sossego.fst output/1st/1st.fst > output/2nd/r-sossego.fst
...
fstcompose output/3rd/calar.fst output/1st/1st.fst > output/3rd/r-calar.fst
...
fstcompose output/3rd/celofane.fst output/1st/1st.fst > output/3rd/r-celofane.fst
...
fstcompose output/3rd/galo.fst output/1st/1st.fst > output/3rd/r-galo.fst
...
fstcompose output/3rd/gelo.fst output/1st/1st.fst > output/3rd/r-gelo.fst
...
fstcompose output/3rd/hoje.fst output/1st/1st.fst > output/3rd/r-hoje.fst
...
fstcompose output/3rd/paz.fst output/1st/1st.fst > output/3rd/r-paz.fst
...
fstcompose output/3rd/quanto.fst output/1st/1st.fst > output/3rd/r-quanto.fst
...
fstcompose output/3rd/rato.fst output/1st/1st.fst > output/3rd/r-rato.fst
...
fstcompose output/3rd/xerox.fst output/1st/1st.fst > output/3rd/r-xerox.fst
...
fstcompose output/4th/aleluia.fst output/1st/1st.fst > output/4th/r-aleluia.fst
...
fstcompose output/4th/aula.fst output/1st/1st.fst > output/4th/r-aula.fst
...
fstcompose output/4th/banana.fst output/1st/1st.fst > output/4th/r-banana.fst
